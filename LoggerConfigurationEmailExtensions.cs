...
namespace Serilog
{
    public static class LoggerConfigurationEmailExtensions
    {
        ...
        /// <summary>
        /// Adds a sink that sends log events via email using MailJet.
        /// </summary>
            ...
            IFormatProvider formatProvider = null)
        {
            ...
            var batchingSink = new PeriodicBatchingSink(new MailJetEmailSink(connectionInfo, formatter), batchingOptions);
